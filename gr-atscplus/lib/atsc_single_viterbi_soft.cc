...
const int atsc_single_viterbi_soft::d_was_sent[4][4] = {
    { 0, 2, 4, 6 },
    { 0, 2, 4, 6 },
    { 1, 3, 5, 7 },
    { 1, 3, 5, 7 },
...
const int atsc_single_viterbi_soft::d_transition_table[4][4] = {
    { 0, 2, 0, 2 },
    { 2, 0, 2, 0 },
    { 1, 3, 1, 3 },
    { 3, 1, 3, 1 },
...
void atsc_single_viterbi_soft::reset()
{
...
float atsc_single_viterbi_soft::best_state_metric() const { return d_best_state_metric; }

char atsc_single_viterbi_soft::decode(float input)
{
