...
#ifndef INCLUDED_ATSCPLUS_ATSC_VITERBI_SOFT_IMPL_H
#define INCLUDED_ATSCPLUS_ATSC_VITERBI_SOFT_IMPL_H
...
#else
#include "atsc_single_viterbi_soft.h"
#endif
...
#else
typedef atsc_single_viterbi_soft single_viterbi_t;
#endif

class atsc_viterbi_soft_impl : public atsc_viterbi_soft
{
private:
...
public:
    ...
    ~atsc_viterbi_soft_impl() override;
...
#endif /* INCLUDED_ATSCPLUS_ATSC_VITERBI_SOFT_IMPL_H */
